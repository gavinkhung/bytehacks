      ...
      datasets: [
        {
          ...
          borderColor: ['rgba(132, 94, 189, 1.0)', 'rgba(86, 105, 174, 1.0)'],
          borderWidth: 1,
        },
      ],
    },
...
$('#youtube').click(function (e) {
  e.preventDefault();
  window.open(
    'https://www.youtube.com/channel/UCaJ4cE6PU3BR9Q6Jg1ygScA/featured?disable_polymer=1',
    '_blank'
  );
});
...
$('#closing').click(function (e) {
  e.preventDefault();
  window.open(
    'https://docs.google.com/presentation/d/1c-UlUuVOSqTN89w7SDki-Ekj7t6TyOI_srRz05jBvOc/edit?usp=sharing',
    '_blank'
  );
});
